      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-14 items-start">
          ...
          <motion.div
            ...
            className="text-left"
          >
            <h1 className="text-[2.5rem] sm:text-5xl md:text-6xl lg:text-6xl xl:text-7xl font-serif font-bold text-foreground leading-[1.1] mb-4 md:mb-6 tracking-tight" style={{ textWrap: 'balance' } as React.CSSProperties}>
