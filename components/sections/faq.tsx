...
export function FAQ() {
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "Yes! I offer high-energy virtual shows specifically designed for Zoom, Microsoft Teams, and other video platforms. Virtual performances include interactive magic that works on screen, audience participation elements, and the same level of customization as in-person events. It's a great solution for remote teams or hybrid events.",
    },
    {
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground">
            Everything you need to know about booking Grant
          </p>
        </motion.div>
